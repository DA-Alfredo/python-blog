...
def register():
    ...
    if request.method == "POST":
        ...
        if user:
            flash("That email is currently in use. Did you mean to log in?")
        else:
...
def login():
    ...
    if request.method == "POST":
        ...
        if user:
            ...
            flash("We don't have an account with that email in our database. Try again")
